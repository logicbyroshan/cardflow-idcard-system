...
const s = StyleSheet.create({
  ...
  floatingCount: { color: '#fff', fontSize: 12, fontFamily: fontFamily.bold },
  floatingCancel: { color: 'rgba(255,255,255,0.7)', fontSize: 10, fontFamily: fontFamily.bold },
  ...
  fBtnText: { fontSize: 10, fontFamily: fontFamily.bold },
});
