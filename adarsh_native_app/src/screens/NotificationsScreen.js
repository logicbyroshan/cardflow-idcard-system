...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: radius.md, padding: 12, borderWidth: 1, borderColor: '#f1f5f9', ...shadows.sm },
  unread: { borderLeftWidth: 3, borderLeftColor: colors.brandPrimary, borderColor: '#f1f5f9' },
  row: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  iconW: { width: 36, height: 36, borderRadius: radius.sm, alignItems: 'center', justifyContent: 'center' },
  body: { flex: 1 },
  titleRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' },
  title: { fontSize: 13, fontWeight: '700', color: colors.gray800, flex: 1, fontFamily: 'SairaSemiCondensed-Bold' },
