...
const s = StyleSheet.create({
  ...
  title: { fontSize: 13, fontFamily: fontFamily.bold, color: colors.gray800, flex: 1 },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.brandPrimary, marginTop: 4, marginLeft: 8 },
  msg: { fontSize: 11, color: colors.gray500, marginTop: 2, lineHeight: 15, fontFamily: fontFamily.medium },
  time: { fontSize: 10, color: colors.gray400, marginTop: 6, fontFamily: fontFamily.regular },
  ...
  emptySub: { fontSize: 11, color: colors.gray300, marginTop: 4, fontFamily: fontFamily.medium },
});
