...
const s = StyleSheet.create({
  ...
  heroSub: { fontSize: 16, color: 'rgba(255,255,255,0.8)', marginTop: 8, fontFamily: fontFamily.regular },
  heroDots: { position: 'absolute', bottom: 20, left: 30, flexDirection: 'row' },
  ...
  viewAll: { fontSize: 14, fontFamily: fontFamily.semibold, color: colors.brandPrimary },
  ...
  catName: { fontSize: 11, fontFamily: fontFamily.bold, color: colors.gray600, textAlign: 'center' },
  ...
  productCat: { fontSize: 11, color: 'rgba(255,255,255,0.7)', marginTop: 2, fontFamily: fontFamily.medium },
  ...
  contactSub: { fontSize: 14, color: 'rgba(255,255,255,0.8)', textAlign: 'center', marginTop: 8, marginBottom: 25, fontFamily: fontFamily.regular },
  form: {},
  ...
  input: { flex: 1, color: '#fff', paddingVertical: 12, fontSize: 14, fontFamily: fontFamily.regular },
  textArea: { height: 80, textAlignVertical: 'top', paddingTop: 12 },
  submitBtn: { backgroundColor: '#fff', borderRadius: radius.md, paddingVertical: 15, alignItems: 'center', marginTop: 10 },
  submitBtnText: { fontSize: 14, fontFamily: fontFamily.bold, color: colors.brandPrimary, letterSpacing: 1 },
  ...
  footerTag: { fontSize: 11, color: colors.gray400, marginTop: 4, fontFamily: fontFamily.medium },
  ...
  version: { fontSize: 10, color: colors.gray300, marginTop: 30, fontFamily: fontFamily.regular },
});
