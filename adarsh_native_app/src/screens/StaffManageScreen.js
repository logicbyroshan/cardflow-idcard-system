      ...
      <View style={s.cardActions}>
        <TouchableOpacity style={s.actionBtn} onPress={() => openAssign(item)}>
          <LinearGradient colors={['#f5f3ff', '#ede9fe']} style={s.actionBtnInner}>
            <IconFilter size={12} color="#8b5cf6" /><Text style={[s.actionBtnText, { color: '#8b5cf6' }]}>{isOperatorMode ? 'CLIENTS' : 'ASSIGN'}</Text>
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity style={s.actionBtn} onPress={() => openEdit(item)}>
          <LinearGradient colors={['#eff6ff', '#dbeafe']} style={s.actionBtnInner}>
            <IconEdit size={12} color="#3b82f6" /><Text style={[s.actionBtnText, { color: '#3b82f6' }]}>EDIT</Text>
          </LinearGradient>
        </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  cardAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.gray50, alignItems: 'center', justifyContent: 'center', marginRight: 12, borderWidth: 1, borderColor: '#f1f5f9' },
  avatarText: { fontSize: 16, fontFamily: fontFamily.bold, color: colors.brandPrimary },
  cardInfo: { flex: 1 },
  cardName: { fontSize: 14, fontFamily: fontFamily.bold, color: colors.gray800 },
  cardEmail: { fontSize: 11, fontFamily: fontFamily.medium, color: colors.gray400 },
  ...
  modalContentFull: { backgroundColor: '#fff', borderTopLeftRadius: radius.lg, borderTopRightRadius: radius.lg, padding: 20 },
  ...
  sectionTitle: { fontSize: 11, fontFamily: fontFamily.bold, color: colors.gray400, letterSpacing: 1, marginBottom: 10, marginTop: 15, textTransform: 'uppercase' },
  ...
  checkLabel: { fontSize: 11, color: colors.gray600, fontFamily: fontFamily.medium },
  checkLabelActive: { color: colors.brandPrimary, fontFamily: fontFamily.bold },
