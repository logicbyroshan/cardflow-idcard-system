...
const s = StyleSheet.create({
  ...
  avatarTxt: { color: '#fff', fontSize: 24, fontFamily: fontFamily.bold },
  userName: { color: '#fff', fontSize: 18, fontFamily: fontFamily.bold, marginBottom: 4 },
  roleBadge: { paddingHorizontal: 10, paddingVertical: 2, borderRadius: radius.xs, borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)' },
  userRole: { color: '#fff', fontSize: 9, fontFamily: fontFamily.bold, letterSpacing: 0.5 },
  details: { padding: 16 },
  editSec: { padding: 16 },
  ...
  eSaveW: { flex: 2 },
  secTitle: { fontSize: 9, fontFamily: fontFamily.bold, color: colors.gray400, letterSpacing: 1.2, marginHorizontal: 20, marginTop: 24, marginBottom: 8, textTransform: 'uppercase' },
  ...
  linkLabel: { flex: 1, fontSize: 13, fontFamily: fontFamily.semibold, color: colors.gray700 },
  ...
  editProfileTxt: { fontSize: 13, fontFamily: fontFamily.bold, color: colors.brandPrimary },
  ...
  updLabel: { fontSize: 8, fontFamily: fontFamily.bold, color: colors.gray400 },
  updValue: { fontSize: 11, fontFamily: fontFamily.bold, color: colors.gray700, marginTop: 2 },
  checkUpdBtn: { marginTop: 12, alignItems: 'center' },
  checkUpdTxt: { fontSize: 11, fontFamily: fontFamily.bold, color: colors.brandPrimary },

  footer: { marginTop: 40, alignItems: 'center', paddingBottom: 20 },
  footerText: { fontSize: 10, color: colors.gray300, fontFamily: fontFamily.semibold },
});
...
const ir = StyleSheet.create({
  ...
  lb: { fontSize: 8, fontFamily: fontFamily.bold, color: colors.gray400, textTransform: 'uppercase' },
  val: { fontSize: 12, fontFamily: fontFamily.semibold, color: colors.gray800 },
});
