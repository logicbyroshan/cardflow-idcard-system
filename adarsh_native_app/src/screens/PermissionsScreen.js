...
const s = StyleSheet.create({
  ...
  permInfo: { flex: 1 },
  permTitle: { fontSize: 14, fontFamily: fontFamily.bold, color: colors.gray800 },
  ...
  statusLabel: { fontSize: 11, fontFamily: fontFamily.bold },
  ...
  grantBtnText: { fontSize: 11, fontFamily: fontFamily.bold, color: '#fff' },
  ...
  settingsBtnText: { fontSize: 13, fontFamily: fontFamily.bold, color: colors.gray600 },
