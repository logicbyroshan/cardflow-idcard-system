...
const s = StyleSheet.create({
  ...
  infoCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: '#eff6ff', borderRadius: radius.lg, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#dbeafe' },
  infoIcon: { width: 36, height: 36, borderRadius: radius.md, backgroundColor: '#dbeafe', alignItems: 'center', justifyContent: 'center' },
  infoText: { flex: 1, fontSize: 12, color: '#1e40af', lineHeight: 18 },
  permCard: { backgroundColor: '#fff', borderRadius: radius.lg, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#f1f5f9', ...shadows.sm },
  permTop: { flexDirection: 'row', alignItems: 'flex-start', gap: 12 },
  permIcon: { width: 44, height: 44, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center' },
  permInfo: { flex: 1 },
  permTitle: { fontSize: 14, fontWeight: '700', color: colors.gray800 },
  ...
  statusBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 6, borderRadius: radius.xs },
  statusLabel: { fontSize: 11, fontWeight: '700' },
  grantBtnWrap: { borderRadius: radius.md, overflow: 'hidden' },
  grantBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: radius.md },
  grantBtnText: { fontSize: 11, fontWeight: '800', color: '#fff' },
  settingsBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 14, backgroundColor: '#fff', borderRadius: radius.lg, borderWidth: 1, borderColor: '#e2e8f0', marginTop: 8, ...shadows.sm },
  settingsBtnText: { fontSize: 13, fontWeight: '600', color: colors.gray600 },
