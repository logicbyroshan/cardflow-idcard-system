...
const s = StyleSheet.create({
  ...
  infoCard: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#eff6ff', borderRadius: radius.lg, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#dbeafe' },
  ...
  settingsBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, backgroundColor: '#fff', borderRadius: radius.lg, borderWidth: 1, borderColor: '#e2e8f0', marginTop: 8, ...shadows.sm },
