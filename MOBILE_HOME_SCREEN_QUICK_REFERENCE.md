...
- **Main Component**: [adarsh_native_app/src/screens/HomeScreen.js](adarsh_native_app/src/screens/HomeScreen.js)
- **Theme Definitions**: [adarsh_native_app/src/theme/index.js](adarsh_native_app/src/theme/index.js)
- **Auth Context**: [adarsh_native_app/src/context/AuthContext.js](adarsh_native_app/src/context/AuthContext.js)
- **API Client**: [adarsh_native_app/src/api/client.js](adarsh_native_app/src/api/client.js)
