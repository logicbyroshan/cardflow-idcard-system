    ...
    if (addFieldBtn) {
        addFieldBtn.addEventListener('click', () => {
            ...
            if (type === 'class_section') {
                ...
                currentFields.push({ name: 'CLASS', type: 'class', order: currentFields.length });
                currentFields.push({ name: 'SECTION', type: 'section', order: currentFields.length });
                renderFieldList();
                newFieldName.value = '';
                resetFieldTypeDropdown();
            ...
            currentFields.push({ name: name, type: finalType, order: currentFields.length });
            renderFieldList();
            newFieldName.value = '';
            resetFieldTypeDropdown();
