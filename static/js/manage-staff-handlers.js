...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openStatusModal(staffName, currentStatus) {
        ...
        if (currentStatus === 'active') {
            ...
            if (statusNote) statusNote.innerHTML = '<i class="fa-solid fa-exclamation-circle"></i> This will prevent the operator from logging in.';
            if (confirmStatusBtn) {
            ...
            if (statusNote) statusNote.innerHTML = '<i class="fa-solid fa-info-circle"></i> This will allow the operator to log in.';
            if (confirmStatusBtn) {
