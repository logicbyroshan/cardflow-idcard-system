...
document.addEventListener('DOMContentLoaded', function() {
      ...
      NS.permissionFields = [
        ...
        'perm_idcard_created_at', 'perm_idcard_updated_at', 'perm_idcard_delete_from_pool', 'perm_reupload_idcard_image', 'perm_idcard_retrieve',
      ...
      NS.openViewModal = function(clientData) {
        ...
        if (permGrid) {
          var permLabels = {
            ...
            'perm_idcard_bulk_upload': 'Bulk Upload', 'perm_idcard_bulk_download': 'Bulk Download',
            'perm_idcard_bulk_reupload': 'Bulk Reupload', 'perm_delete_all_idcard': 'Delete All Cards',
