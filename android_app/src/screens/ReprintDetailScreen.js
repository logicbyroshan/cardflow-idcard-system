...
export default function ReprintDetailScreen({ navigation, route }) {
  ...
  const hasDownloadTab = perms.perm_idcard_reprint_list || perms.perm_reprint_request_list || isAdminOrOperator;
  const hasRequestTab = perms.perm_reprint_request_list || perms.perm_idcard_reprint_list || isAdminOrOperator;
