...
class WebsiteConfig(AppConfig):
    ...
    def ready(self):
        ...
        from .models import BusinessDetails, Feature, HeroImage, PortfolioItem, Testimonial
        ...
        models_to_watch = (BusinessDetails, HeroImage, Feature, Testimonial, PortfolioItem)
