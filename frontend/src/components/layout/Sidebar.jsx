...
export default function Sidebar({ activeTab, setActiveTab, userRole = 'super_admin', currentUser, onLogout }) {
  ...
  return (
    <aside className="sidebar" id="sidebar">
      {/* ── Header / Logo ── */}
      <div className="sidebar-header" style={{ padding: '4px 8px', height: '50px', minHeight: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', borderBottom: '1px solid rgba(255, 255, 255, 0.06)', borderRight: '1px solid rgba(255, 255, 255, 0.12)', background: '#1e1e2e', boxSizing: 'border-box' }}>
        <img
