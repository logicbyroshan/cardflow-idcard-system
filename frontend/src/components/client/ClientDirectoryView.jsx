          ...
          <div className="actions" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <div className="btn-group" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              <button
                ...
                style={{ background: '#334155', color: '#ffffff', height: '28px', padding: '0 10px', fontSize: '11px', fontWeight: 600, borderRadius: '4px', border: 'none', cursor: selected ? 'pointer' : 'not-allowed', opacity: selected ? 1 : 0.45, display: 'inline-flex', alignItems: 'center', gap: '5px' }}
              >
              ...
              <button
                ...
                style={{ background: showManagersDrawer ? '#2563eb' : '#334155', color: '#ffffff', height: '28px', padding: '0 10px', fontSize: '11px', fontWeight: 600, borderRadius: '4px', border: 'none', cursor: selected ? 'pointer' : 'not-allowed', opacity: selected ? 1 : 0.45, display: 'inline-flex', alignItems: 'center', gap: '5px' }}
              >
              ...
              <button
                ...
                style={{ background: showAssistantsDrawer ? '#2563eb' : '#334155', color: '#ffffff', height: '28px', padding: '0 10px', fontSize: '11px', fontWeight: 600, borderRadius: '4px', border: 'none', cursor: selected ? 'pointer' : 'not-allowed', opacity: selected ? 1 : 0.45, display: 'inline-flex', alignItems: 'center', gap: '5px' }}
              >
