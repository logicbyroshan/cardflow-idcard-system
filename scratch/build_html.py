...
# Escape backticks and template literals for JS template string embedding
escaped = html_content.replace('\\', '\\\\').replace('`', '\\`').replace('${', '\\${')

output = '// Auto-generated offline face detector (Canvas pixel analysis)\nexport const faceDetectorHtml = `' + escaped + '`;\n'

out_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                        'android_app', 'src', 'utils', 'faceDetectorHtml.js')
