...
# COPY THE EXACT LOGIC FROM update_staff
...
print("Initial resolved_table_ids:", resolved_table_ids)
...
if ('assigned_groups' in data) or (normalized_assignment_scopes is not None):
    ...
    print("Mid resolved_table_ids:", resolved_table_ids)
    ...
    print("Final resolved_table_ids:", resolved_table_ids)
